...
template <typename T>
__device__ void 
setab(T* delay, volatile struct s_var* var)
{
#pragma GCC push_options
#pragma GCC optimize ("O0")
	var->a = 0;
...
template <typename T>
__global__ void
MP1(T* cpu_rand, volatile struct s_var* var, unsigned N)
{
...
int check_output(unsigned t_range)
{
   ...
   if (!res_cpu0_gpu1) {
        ...
        std::cout << "=========================================================================" << std::endl;
        std::cout << "	\t Compound MP1-cta-F Disallowed  \t " << std::endl;						
        std::cout << "=========================================================================" << std::endl; 
        return 0;
    } else {
        ...
        std::cout << "Num Invalid test: " << res_cpu0_gpu1 << std::endl;
        std::cout << "=========================================================================" << std::endl;
        std::cout << "	\t Compound MP1-cta-F Allowed  \t " << std::endl;						
        std::cout << "=========================================================================" << std::endl;
        return 2;
    }
}
