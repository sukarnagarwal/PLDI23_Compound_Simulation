...
template <typename T>
__device__ void 
loadb_storea(T* delay, struct s_var* var, volatile struct r_gpu0* res1)
{
#pragma GCC push_options
#pragma GCC optimize ("O0")	
...
template <typename T>
__global__ void
LB1(T* gpu_rand, struct s_var* var, volatile struct r_gpu0* gpu_res, unsigned N)
{
...
#pragma GCC optimize ("O0") 
    	if(i < N) {
    		loadb_storea(&gpu_rand[i], (var + (i)), &gpu_res[i]);		
    	}
#pragma GCC pop_options        	
}
...
int check_output(unsigned t_range)
{
    ...
    for (auto i = 0; i < t_range; ++i) {
     ...
     if (!res_cpu1_gpu1) {
        ...
        std::cout << "=========================================================================" << std::endl;
        std::cout << "	\t Compound LB-sys with SWMR voilation Disallowed  \t " << std::endl;						
        std::cout << "=========================================================================" << std::endl; 
        return 0;
    } else {
        ...
        std::cout << "Num Invalid test: " << res_cpu1_gpu1 << std::endl;
        std::cout << "=========================================================================" << std::endl;
        std::cout << "	\t Compound LB-sys with SWMR voilation Allowed  \t " << std::endl;						
        std::cout << "=========================================================================" << std::endl; 
        return 2;
    }
}
