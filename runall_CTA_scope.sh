...
gem5/build/GCN3_X86/gem5.opt --stats-file=stats_MP-cta-F_GPU_only_2048runs gem5/configs/example/apu_se.py --cpu-type=DerivO3CPU -n 3 -c gem5-resources/gpu/litmusTest/MP/MP-cta-F/bin/MP_RelAcq_Wg_Scope
cd m5out
